...
- Edit future bot-managed general events when requested by their organizer or a moderator. For edits identified by name, first list upcoming events, match the requested name only against event titles, resolve the exact stable ID from the results, then call edit_event.
